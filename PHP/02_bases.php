...
<!-- Ecriture du code php -->
 ...
 # ceci aussi est un commentaire php
 /* un
 commentaire
 à 
 plusieurs 
 ...
 */
 ?>
            ...
            <div class="col-sm-12">
                    ...
                    <ul>
                        ...
                        //    les () sont facultatives
                           echo ("Je suis un texte en php dans une instruction")
                           ?> 
            ...
            <div class="col-sm-12">
                ...
                <p>Une constante permet de conserver une valeur suaf que celle-ci ne peut pas changer. C'est à dire qu'on ne pourras pas la modifier durant l'exécution du script. Utile par exemple pour conserver les parametres de connexion à la BDD d'une façon certaine. </p>
